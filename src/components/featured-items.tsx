...
import { useFavoriteMenuItems } from "@/hooks/use-menu-items";

export function FeaturedItems() {
  const { data: favoriteItems, error } = useFavoriteMenuItems();

  if (error) return <div>Error loading featured items</div>;
